...
using SvelteKitDotNet.Extensions.Proxying;
using SvelteKitDotNet.Extensions.Util;

namespace SvelteKitDotNet.Extensions.SvelteKit
{
    internal static class SvelteKitDevelopmentServerMiddleware
    {
            ...
            string scriptName)
        {
            ...
            var portTask = StartCreateSvelteKitAppServerAsync(sourcePath, scriptName, pkgManagerCommand, devServerPort,
                logger, diagnosticSource, applicationStoppingToken);
        ...
        private static async Task<int> StartCreateSvelteKitAppServerAsync(
            ...
            DiagnosticSource diagnosticSource, CancellationToken applicationStoppingToken)
        {
            ...
            logger.LogInformation($"Starting SvelteKit server on port {portNumber}...");
            ...
            using (var stdErrReader = new EventedStreamStringReader(scriptRunner.StdErr))
            {
                try
                {
                    // Although the SvelteKit dev server may eventually tell us the URL it's listening on,
                ...
                catch (EndOfStreamException ex)
                {
                    throw new InvalidOperationException(
                        ...
                        $"Svelte Kit server was listening for requests. The error output was: " +
